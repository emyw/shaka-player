  ...
  static async getDecodingInfosForVariants(variants, usePersistentLicenses,
    ...
    const getVariantDecodingInfos = (async (variant, decodingConfig) => {
      try {
        ...
        // Use debug level instead of info level to avoid printing tons
        // of these when only basic info is desired
        shaka.log.debug('MediaCapabilities.decodingInfo() failed.',
